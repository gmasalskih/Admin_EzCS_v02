...
data class MapPointsEditState(
    ...
    val id: String = "",
    val name: String = "palas_to_under_palas",
    val grenadeType: GrenadeTypes = GrenadeTypes.SMOKE,
    val listTickRates: List<TickRate> = listOf(TickRate.TICKRATE_64),
    val pathToPreviewStart: String = "D:/EzCS/map_points/palas_to_under_palas_start.png",
    val pathToPreviewEnd: String = "D:/EzCS/map_points/palas_to_under_palas_end.png",
